(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            if (document.querySelector("[data-range]")) {
                ...
                if (rangeItems.length) rangeItems.forEach((rangeItem => {
                    ...
                    const inputsPrice = [ fromValue, toValue ];
                    initialize(item, {
                        start: [ 1e3, 1e4 ],
                        connect: true,
                        range: {
                    ...
                    fromValue.addEventListener("change", setPriceValues);
                    toValue.addEventListener("change", setPriceValues);
                    function setPriceValues() {
                        let priceStartValue;
                        let priceEndValue;
                        if (fromValue.value != "") priceStartValue = fromValue.value;
                        if (toValue.value != "") priceEndValue = toValue.value;
        ...
        function initSliders() {
            if (document.querySelector(".slider-hero")) new swiper_core_Swiper(".slider-hero__slider", {
            ...
            if (document.querySelector(".slider-shop")) new swiper_core_Swiper(".slider-shop__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                loop: true,
                navigation: {
                    prevEl: ".slider-shop__arrows .arrows__arrow--prev",
                    nextEl: ".slider-shop__arrows .arrows__arrow--next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".slider-details-product")) {
                const thumbsSlider = new swiper_core_Swiper(".thumbs-slider-details__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    autoHeight: true,
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".thumbs-slider-details__arrows .arrows__arrow--prev",
                        nextEl: ".thumbs-slider-details__arrows .arrows__arrow--next"
                    },
                    breakpoints: {
                        320: {
                            slidesPerView: 4,
                ...
                new swiper_core_Swiper(".slider-details-product__slider", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".slider-history")) new swiper_core_Swiper(".slider-history__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".slider-history__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-history__controlls .slider-history__arrow--prev",
                    nextEl: ".slider-history__controlls .slider-history__arrow--next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".scroll-top")) scrollTop();
            if (targetElement.closest(".banner-header__delete")) {
                targetElement.closest(".banner-header").remove();
                document.documentElement.classList.add("_hide-banner");
            }
            if (targetElement.closest(".actions-header__icon--cart")) {
                document.querySelector(".actions-header__cart").classList.toggle("_show-cart");
                targetElement.classList.toggle("_active");
            } else if (!targetElement.closest(".actions-header__cart") && document.querySelector(".actions-header__cart._show-cart")) {
                document.querySelector(".actions-header__cart").classList.remove("_show-cart");
                document.querySelector(".actions-header__icon--cart").classList.remove("_active");
            }
            if (targetElement.closest(".actions-header__icon--profile")) {
                document.querySelector(".profile-actions-header").classList.toggle("_show-profile");
                targetElement.classList.toggle("_active");
            } else if (!targetElement.closest(".profile-actions-header") && document.querySelector(".profile-actions-header._show-profile")) {
                document.querySelector(".profile-actions-header").classList.remove("_show-profile");
                document.querySelector(".actions-header__icon--profile").classList.remove("_active");
            }
            if (targetElement.closest(".categories-header__all")) targetElement.closest(".categories-header").classList.add("_categories-active"); else if (!targetElement.closest(".categories-header") && document.querySelector(".categories-header._categories-active")) {
                document.querySelector(".categories-header").classList.remove("_categories-active");
                const categoriesSubItem = document.querySelectorAll(".categories-header__item");
                const categoriesSubLink = document.querySelectorAll(".categories-header__link--parent");
                categoriesSubItem.forEach((item => {
                    item.classList.contains("_show-sub-categories") ? item.classList.remove("_show-sub-categories") : null;
                }));
                categoriesSubLink.forEach((link => {
                    link.classList.contains("_active-link") ? link.classList.remove("_active-link") : null;
                }));
            }
            if (targetElement.closest(".categories-header__link--parent")) {
                e.preventDefault();
                const activeLink = document.querySelector("._active-link");
                const activeSubItem = document.querySelector("._show-sub-categories");
                if (activeLink && activeLink !== targetElement) {
                    activeLink.classList.remove("_active-link");
                    activeSubItem.classList.remove("_show-sub-categories");
                }
                targetElement.closest(".categories-header__item").classList.toggle("_show-sub-categories");
                targetElement.classList.toggle("_active-link");
            }
            if (targetElement.closest(".categories-header__close")) targetElement.closest(".categories-header").classList.remove("_categories-active");
            if (targetElement.closest(".sub-list-categories__back")) {
                targetElement.closest(".categories-header__item").classList.remove("_show-sub-categories");
                document.querySelectorAll(".categories-header__link").forEach((linkMob => {
                    linkMob.classList.remove("_active-link");
                }));
            }
            if (targetElement.closest(".top-content-catalog__filter-mob")) {
                document.querySelector(".filter-catalog").classList.add("_show-catalog");
                document.documentElement.classList.add("lock");
            } else if (!targetElement.closest(".filter-catalog") && document.querySelector(".filter-catalog._show-catalog")) {
                document.querySelector(".filter-catalog").classList.remove("_show-catalog");
                document.documentElement.classList.remove("lock");
                if (window.innerWidth < 992) filterScrollTop();
            } else if (targetElement.closest(".filter-catalog__close")) {
                document.querySelector(".filter-catalog").classList.remove("_show-catalog");
                document.documentElement.classList.remove("lock");
                if (window.innerWidth < 992) filterScrollTop();
            }
            if (targetElement.closest(".actions-payment__more")) {
                targetElement.classList.toggle("_animate-dotts");
                targetElement.closest(".actions-payment").classList.toggle("_show-action");
            } else if (!targetElement.closest(".actions-payment") && document.querySelector(".actions-payment._show-action")) {
                const actionButton = document.querySelectorAll(".actions-payment__more");
                actionButton.forEach((btn => {
                    btn.classList.remove("_animate-dotts");
                }));
                const actionsBlock = document.querySelectorAll(".actions-payment");
                actionsBlock.forEach((block => {
                    block.classList.remove("_show-action");
                }));
            }
            if (targetElement.closest(".calendar-browsing__item")) {
                targetElement.classList.toggle("_item-calendar-active");
                targetElement.closest(".calendar-browsing").classList.toggle("_show-calendar");
            } else if (!targetElement.closest(".calendar-browsing") && document.querySelector(".calendar-browsing._show-calendar")) {
                document.querySelector(".calendar-browsing__item").classList.remove("_item-calendar-active");
                document.querySelector(".calendar-browsing").classList.remove("_show-calendar");
            }
        }
        if (!isMobile.any()) {
            document.addEventListener("focusin", (function(e) {
                if (e.target.classList.contains("card__button")) e.target.closest(".card__buttons").classList.add("_focus");
            }));
            document.addEventListener("focusout", (function(e) {
                if (e.target.classList.contains("card__button")) e.target.closest(".card__buttons").classList.remove("_focus");
            }));
        }
        function countdown() {
            ...
            elements.forEach((element => {
                ...
                const interval = setInterval((() => {
                    ...
                    if (distance < 0) {
                        ...
                        element.innerHTML = `\n        <div class="counter-deals__remove">\n          <div class="counter-deals__remove-label">The promotion has ended</div>\n        </div>`;
                    } else element.innerHTML = `\n        <div class="counter-deals__item">\n          <div class="counter-deals__time counter-deals__time--days">${days < 10 ? "0" + days : days}</div>\n          <div class="counter-deals__label">d</div>\n        </div>\n        <div class="counter-deals__item">\n          <div class="counter-deals__time counter-deals__time--days">${hours < 10 ? "0" + hours : hours}</div>\n          <div class="counter-deals__label">h</div>\n        </div> \n        <div class="counter-deals__item">\n          <div class="counter-deals__time counter-deals__time--days">${minutes < 10 ? "0" + minutes : minutes}</div>\n          <div class="counter-deals__label">m</div>\n        </div>\n        <div class="counter-deals__item">\n          <div class="counter-deals__time counter-deals__time--days">${seconds < 10 ? "0" + seconds : seconds}</div>\n          <div class="counter-deals__label">s</div>\n        </div>`;
                }), 1e3);
            }));
        }
        countdown();
        ...
        function showScrollBtn() {
            ...
            if (document.querySelector(".scroll-top")) {
                ...
                if (windowScroll > 700) scrollButton.classList.add("scroll-top--show"); else scrollButton.classList.remove("scroll-top--show");
            }
        }
        function scrollTop() {
            window.scrollTo({
